...
public class AnkiDroidPlugin extends Plugin {
    ...
    public void addNote(PluginCall call) {
        ...
        try {
            ...
            noteValues.put("tags", "SuguAnki");
            // Basic fields are separated by unit separator (\u001f)
            noteValues.put("flds", front + "\u001f" + back);
            
            Log.i("SuguAnki", "Attempting to insert note for Deck ID: " + deckId + ", Model ID: " + modelId);
            ...
            if (newNoteUri != null) {
                ...
                Log.i("SuguAnki", "Successfully generated " + cardsGenerated + " cards for Note ID " + newNoteUri.getLastPathSegment());
                call.resolve(ret);
            } else {
