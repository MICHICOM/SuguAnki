const languageNames = {
  ja: {
    English: "英誁E(English)",
    Japanese: "日本誁E(Japanese)",
    German: "ドイチE��E(German)",
    French: "フランス誁E(French)",
    Spanish: "スペイン誁E(Spanish)",
    Italian: "イタリア誁E(Italian)",
    Chinese: "中国誁E(Chinese)",
    Korean: "韓国誁E(Korean)",
    Russian: "ロシア誁E(Russian)",
    Portuguese: "ポルトガル誁E(Portuguese)",
    Dutch: "オランダ誁E(Dutch)",
    Arabic: "アラビア誁E(Arabic)",
    "Auto-detect": "自動検�E (Auto)"
  },
  en: {
    English: "English",
    Japanese: "Japanese",
...
const translations = {
  ja: {
    app_lang_label: "シスチE��言誁E,
    model_label: "AIモチE��",
    get_api_key: "APIキーの取得�EこちらかめE(Get API Key)",
    model_31_lite: "Gemini 3.1 Flash Lite (推奨・1日500囁E",
    model_25_flash: "Gemini 2.5 Flash (1日20囁E",
    model_35_flash: "Gemini 3.5 Flash (最新・1日20囁E",
    settings: "チE��キ設宁E,
    settings_title: "アプリ設宁E,
    licenses_btn: "クレジチE��とライセンス",
    licenses_title: "クレジチE��とライセンス",
    save: "保孁E,
    api_key_tip: "キーはローカル環墁E�E <code>.env</code> ファイルに安�Eに保存されます、E,
    deck_label: "登録先デチE�� (Deck)",
    no_decks: "チE��キがありません (No decks)",
    loading: "ロード中...",
    input_label: "単語�E劁E,
    learn_label: "学ぶ言誁E,
    explain_label: "説明�E言誁E,
    word_label: "単語を入劁E,
    word_placeholder: "侁E ephemeral, Haus, éphémère",
    generate_btn: "カードを作る",
    generating: "生�E中...",
    recent_title: "最近追加した単誁E,
    recent_empty: "こ�EセチE��ョンで追加されたカード�Eありません",
    preview_title: "生�Eプレビュー",
    preview_placeholder: "単語を入力して生�Eすると、ここにAnkiカード�Eプレビューが表示されます、E,
    tab_front: "表面 (Front)",
    tab_back: "裏面 (Back)",
    tab_details: "詳細チE�Eタ",
    tab_general: "一般",
    ...
    field_article: "冠詁E(Article)",
    field_gender: "性別 (Gender)",
    gender_none: "なぁE(None)",
    ...
    field_etymology: "語溁E(Etymology)",
    field_example_org: "例文 [学習言語] (Example Original)",
    field_example_tr: "例文 [説明言語] (Example Translation)",
    edit_tip: "💡 登録前にチE�Eタを微調整できます。調整した冁E��は「裏面プレビュー」に即時反映されます、E,
    register_btn: "カードを登録する",
    new_deck_title: "新しいチE��キの作�E",
    new_deck_desc: "作�EするチE��キ名を入力してください�E�ネストする階層は \"English::Vocab\" のようにコロン2つで区刁E��て持E��できます）、E,
    cancel: "キャンセル",
    create: "作�E",
    status_connected: "接続中",
    status_disconnected: "未接綁E,
    status_configured: "設定渁E,
    status_missing: "未設宁E,
    status_connected_desc: "AnkiConnectと接続されてぁE��ぁE,
    status_disconnected_desc: "AnkiConnectが見つかりません、Enkiが起動しており、アドオンがインスト�EルされてぁE��ことを確認してください、E,
    toast_api_key_required: "APIキーを�E力してください、E,
    toast_api_key_saved: "APIキーを保存しました、E,
    toast_server_error: "サーバ�Eとの通信に失敗しました、E,
    toast_anki_disconnected: "Ankiに接続されてぁE��せん、E,
    toast_enter_deck_name: "チE��キ名を入力してください、E,
    toast_deck_created: "チE��キ \"{name}\" を作�Eしました、E,
    toast_gemini_key_required: "Gemini APIキーを設定してください、E,
    toast_gen_complete: "カード�E生�Eが完亁E��ました�E�E,
    toast_select_deck: "登録先デチE��を選択してください、E,
    toast_add_success: "AnkiチE��キ \"{name}\" に登録しました�E�E,
    toast_add_error: "登録エラー: ",
    update_available: "新しいアチE�EチE�Eト！Elatest}�E�が利用可能です、Enダウンロードしてインスト�Eルしますか�E�\n(現在のバ�Eジョン: {current})",
    update_downloading: "アチE�EチE�Eト�Eダウンロードを開始しまぁE..",
    update_ready: "ダウンロード完亁E��インスト�Eルを開始しまぁE..",
    update_plugin_error: "忁E��なプラグインがロードされてぁE��せん",
    update_error: "アチE�EチE�Eト�E確認�E処琁E��にエラーが発生しました: ",
    field_pos: "品詁E(Part of Speech)",
    field_pronunciation: "発音記号 (Pronunciation)",
    generate_custom_fields: "カスタムフィールドを生�Eする (消費ト�EクンↁE",
    custom_fields_setting_title: "カスタムフィールチE,
    custom_fields_setting_desc: "ここで設定した頁E��をAIが抽出しまぁE,
    save_cf_btn: "フィールド設定を保孁E,
    app_theme_label: "アプリチE�EチE,
    card_theme_label: "カード�E力用CSS",
    add_cf_btn: "追加"
  },
  en: {
    ...
    generate_custom_fields: "Generate Custom Fields (TokenↁE",
...
const cardSubtitles = {
  Japanese: { meaning: "意味", coreImage: "コアイメージ", etymology: "語溁E, example: "例文", inflectionTable: "活用・変化表" },
  ...
  Chinese: { meaning: "含乁E, coreImage: "核忁E��象", etymology: "词溁E, example: "例句", inflectionTable: "词形变化" },
  Korean: { meaning: "�E�미", coreImage: "����E� �E��E��E�", etymology: "�E��E�E, example: "�E�문", inflectionTable: "���용���E },
  Russian: { meaning: "ЗнасE�ние", coreImage: "КлюсE�вой образ", etymology: "ЭтимологисE, example: "Пример", inflectionTable: "Склонение / Спряжение" },
  ...
  Arabic: { meaning: "افE�E�فE�E, coreImage: "افE�ورة افE�ساسية", etymology: "أصفEافE�E�E�E�", example: "فE�افE, inflectionTable: "جدوفEافE�صريفE }
};
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    try {
      ...
      if (isAndroidApp) {
        ...
        if (!plugins || !plugins.AnkiDroid) {
          throw new Error("ネイチE��ブ�Eラグイン AnkiDroid が検�Eされませんでした、E);
        }
        ...
        if (!permStatus.granted) {
          throw new Error("AnkiDroidへのチE�Eタベ�Eスアクセス権限がありません。設定から許可してください、E);
        }
      }
  ...
  function populateDecks(decks) {
    ...
    if (decks.length === 0) {
      ...
      opt.value = '';
      opt.textContent = translations[state.appLang].no_decks || "チE��キがありません"; // Placeholder
  ...
  newDeckBtn.addEventListener('click', () => {
    ...
    if (isAndroidApp) {
      alert("Android版ではアプリから直接チE��キを作�Eできません、Enお手数ですが、一度 AnkiDroid アプリを開ぁE��チE��キを作�Eしてから、�E度お試しください、E);
      return;
    }
  ...
  function addCustomFieldInput(val = '') {
    ...
    input.type = 'text';
    input.value = val;
    input.placeholder = '侁E Past Tense';
...
You must return the dictionary base form (原型) of the expression in ${sourceLang} (if it's an idiom or phrasal verb, return its standard base form, e.g., 'kick the bucket', 'look forward to'), its part of speech (品詁E in ${sourceLang} (e.g., Idiom, Phrasal Verb, Noun, Verb, etc.), its pronunciation (発音記号) in IPA format, its meaning in ${targetLang}, the core image/essence (コアイメージ) of the expression in ${targetLang} (keep it concise and clear), the etymology/word origin (語溁E of the expression in ${targetLang} (explain prefixes, roots, or origin briefly. If it is a compound word (合�E誁E, explicitly state so and briefly explain its parts. If not applicable or unknown, explicitly state "不�E" (Unknown) and provide a very brief explanation. Do not output a single character or empty parentheses), and a helpful example sentence in ${sourceLang} with its translation in ${targetLang}.`;
  ...
  addToAnkiBtn.addEventListener('click', async () => {
    ...
    try {
      ...
      if (res && res.cardsGenerated === 0) {
        showToast("AnkiにチE�Eタは送信されましたが、カードが生�Eされませんでした、Enkiのノ�EトタイチE基本など)のフィールド設定を確認してください、E, 'error');
      } else {
